...
public class Day1 {	public static void main(String[] args) throws FileNotFoundException {
	Scanner scanner = new Scanner(Day1.class.getClassLoader().getResourceAsStream("test2.txt"));
